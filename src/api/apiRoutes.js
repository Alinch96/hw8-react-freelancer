// routes.js
const API_BASE_URL = 'https://backend-teachers-hw8.onrender.com/api'

export default {
  // GET: Отримати всіх вчителів
  getAllTeachers: `${API_BASE_URL}/teachers`,
  
  // GET: Отримати вчителів з полем isSelected: true
  getSelectedTeachers: `${API_BASE_URL}/teachers/selected`,
  ...
  selectTeacherById: (id) => `${API_BASE_URL}/teachers/${id}`,
